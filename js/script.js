...
const getDiscordOnlineUsers = async () => {
    try {
        ...
        const apiWidgetUrl = `https://discord.com/api/guilds/1279333791239766048/widget.json`;
...
const getMinecraftOnlinePlayer = async () => {
    try {
        ...
        const apiUrl = `https://api.mcsrvstat.us/2/play.drakulamc.fun`;
...
const setDataFromConfigToHtml = async () => {
    ...
    if(locationPathname == "/" || locationPathname.includes("index")) {
        ...
        contactForm.action = `https://formsubmit.co/notgamerpratham@gmail.com`;
        discordOnlineUsers.innerHTML = await getDiscordOnlineUsers();
